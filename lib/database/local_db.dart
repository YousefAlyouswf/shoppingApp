...
class DBHelper {
  static Future<Database> database() async {
    ...
    return sqlite.openDatabase(
      ...
      onCreate: (db, version) async {
        await db.execute(
            "CREATE TABLE cart(id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, nameEn TEXT,  price TEXT, image TEXT, des TEXT,desEn TEXT, q TEXT, buyPrice TEXT, size TEXT, productID TEXT, totalQ TEXT, priceOld TEXT)");
        await db.execute(
  ...
  static Future<void> deleteCard(String table, int id) async {
    final db = await DBHelper.database();
